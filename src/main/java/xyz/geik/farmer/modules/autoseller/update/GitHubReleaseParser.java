...
public final class GitHubReleaseParser {
    ...
    private static final String RELEASE_PATH = "/siberanka/TwiFarmer-AutoSell/releases/";
    ...
    private static Optional<String> findJarAsset(JsonArray assets) {
        ...
        for (JsonElement element : assets) {
            ...
            if (name != null && name.startsWith("Farmer-AutoSeller-") && name.endsWith(".jar")) {
                Optional<String> url = validatedReleaseUrl(string(asset, "browser_download_url"));
    ...
    private static Optional<String> validatedReleaseUrl(String raw) {
        ...
        try {
            ...
            if (!"https".equalsIgnoreCase(uri.getScheme())
                    ...
                    || uri.getPath() == null || !uri.getPath().startsWith(RELEASE_PATH)) {
                return Optional.empty();
            }
